...
<p id="comments" class="bold">Comments</p>
...
<?php $args = array(
    ...
    'comment_field' => '<p class="comment-form-comment">' . '<textarea id="comment" name="comment" cols="35" rows="3" aria-required="true"' . $aria_req . ' placeholder="COMMENT" /></textarea></p>',
    );
comment_form( $args ); ?>
</div>